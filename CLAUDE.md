...
**YOU ARE IN: `karpenter/polecats/jasper/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/karpenter/` (rig root) or other directories
...
**Your mail address:** `karpenter/polecats/jasper`
**Your rig:** karpenter
**Your Witness:** `karpenter/witness`
...
| Ask Witness for help | `gt mail send karpenter/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`karpenter/witness`) when:
...
```bash
gt mail send karpenter/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
