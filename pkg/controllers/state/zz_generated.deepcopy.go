...
func (in *StateNode) DeepCopyInto(out *StateNode) {
	*out = *in
	...
	out.lastResizeCompletionTime = in.lastResizeCompletionTime
	if in.podResizeStatuses != nil {
		in, out := &in.podResizeStatuses, &out.podResizeStatuses
		*out = make(map[types.NamespacedName]v1.PodResizeStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
