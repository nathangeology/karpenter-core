...
// getSizeClassFromCPU returns the size class (1-5) based on vCPU count
// Size classes follow common cloud VM patterns:
// Class 1: 1-2 vCPU, Class 2: 4 vCPU, Class 3: 8 vCPU, Class 4: 16 vCPU, Class 5: 32+ vCPU
